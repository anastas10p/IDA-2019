---
title: "General Tasks"
author: Philipp Herpich, Marina Matthaiou , Daniel Schewitz,  Tatjana Stefanie Spanehl,   Anastasios
  Tsigkros,
date: "31 August 2019"
output: html_document
---

In addition to the case study, some general tasks should also be worked on. The General Tasks described below are divided into six tasks. Their solutions and associated code can be seen in more detail.
...
### Distribution of Logisticsdelay

How is the logistics delay distributed? Justify your selection and briefly describe your 
approach. 
...
We will now see the max and min time.... With function mean() we determine the  the mean of the Logosticdelay....
```{r min and max time}
...
Everything we know about Fahrzeug are written in one table. We use  rbind() in order to seeall vehicles registered. 
```{r all vehicles}
...
The ID of our vehicle is K1BE2-104-1041-32049. Our main task is to find out in which "Gemeinde" is the wanted vehicle 
...
he vehicle with the engine code "K1BE2-104-1041-32049" was registered at 26 November 2009 in Leipzig. 